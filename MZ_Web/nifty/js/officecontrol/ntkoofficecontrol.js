...
//        TANGER_OCX_OBJ.ActiveDocument.Application.Selection.Goto(-1, 0, 0, BookMarkName); //定位书签
...
var codebase64 = "officecontrol/OfficeControlx64.cab#version=5,0,2,9";
if (browser == "IE") {
    if (window.navigator.platform == "Win32") {
        ...
        document.write('<param name="ProductCaption" value="湖南谱典信息技术有限公司"> ');
        document.write('<param name="ProductKey" value="A2C22371E0F0E25341CFA5AD567FC1D2E2FBFC4E">');
        ...
        document.write('<param name="Caption" value="BPM协同办公平台">   ');
    ...
    document.write('_ProductCaption="湖南谱典信息技术有限公司" ');
    document.write('_ProductKey="A2C22371E0F0E25341CFA5AD567FC1D2E2FBFC4E"');
    ...
    document.write('_MenuButtonStyle="7"   ');
    document.write('_WebUserName="NTKO"   ');
    document.write('_Caption="BPM协同办公平台">    ');
