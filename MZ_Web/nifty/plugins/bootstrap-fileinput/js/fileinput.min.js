...
!function (e) {
    ...
    i = {
        ...
        constructor: t, _cleanup: function () {
            ...
            var t, a, n, r, o, l, s, d, c, u, p, f, m, v, h, g, w, _, b, C, y, T, E, x, F, S, I, k, P, z, A, $, D, U, j,
                B, L = this;
            ...
            var n, r, o, l, s, d, c, u, p, f, m, v = this, h = v.getFileStack().length, g = new FormData,
                w = v.previewInitId + "-" + t, _ = v.filestack.length > 0 || !e.isEmptyObject(v.uploadExtraData),
            ...
            v.formdata = g, v.showPreview && (r = e("#" + w + ":not(.file-preview-initial)"), l = r.find(".kv-file-upload"), s = r.find(".kv-file-remove"), b.removeClass("hide")), 0 === h || !_ || l && l.hasClass("disabled") || v._abort(C) || (f = function (e, i) {
                ...
                var e, t, a, n = v.uploadCache, r = 0, o = v.cacheInitialPreview;
            ...
            n.loadedImages = [], n.totalImagesCount = 0, e.each(t, function (e, i) {
                ...
                var T, E, x, F, S, I, k, P, z, A, $ = v + e, D = p + "-" + $, U = t[e],
                    j = U.name ? n.slug(U.name) : "", B = (U.size || 0) / 1e3, L = "", O = i.objUrl.createObjectURL(U),
                    R = 0, Z = "";
                ...
                return 0 !== R || i.isEmpty(w) || !i.isArray(w) || i.isEmpty(L) || (k = i.compare(j, L), R += i.isEmpty(k) ? 0 : k.length, 0 !== R) ? n.showPreview ? !C && B > b ? (n.addToStack(U), s.addClass("file-thumb-loading"), n._previewDefault(U, D), n._initFileActions(), n._updateFileDetails(f), void a(e + 1)) : (o.length && void 0 !== FileReader ? (d.html(c.replace("{index}", e + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
                    ...
                    S = u.setTokens({index: e + 1, files: f, percent: 50, name: j}), setTimeout(function () {
                    ...
                    if (i.lengthComputable) {
                        ...
                        S = u.setTokens({index: e + 1, files: f, percent: a, name: j}), setTimeout(function () {
                            d.html(S)
                        }, 100)
                    }
            ...
            if (s.$caption.length) {
                if (a) n = e("<div>" + s.msgValidationError + "</div>").text(), o = d.length, l = o ? 1 === o && d[0] ? s._getFileNames()[0] : s._getMsgSelected(o) : s._getMsgSelected(s.msgNo), r = '<span class="' + s.msgValidationErrorClass + '">' + s.msgValidationErrorIcon + (i.isEmpty(t) ? l : t) + "</span>"; else {
