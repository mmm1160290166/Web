    ...
    function Flash(root, opts, conf) {
        ...
        if (f.isSupported(opts.version)) {
            ...
            if (!root.innerHTML.replace(/\s/g, '')) {
                ...
                root.innerHTML =
                    "<h2>您的浏览器不兼容FlexPaper</h2>" +
                        "<h3>升级到一个新的浏览器或下载Adobe Flash播放器10或更高.</h3>" +
                        "<p>点击下面的图标下载Adobe Flash的最新版本" +
                        "<a href='https://get2.adobe.com/cn/flashplayer/' target='_blank'><img src='"
                        + pageHost + "www.adobe.com/images/shared/download_buttons/get_flash_player.gif'/></a>";
